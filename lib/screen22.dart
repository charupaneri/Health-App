...
class Doc_screens extends StatelessWidget{
  const Doc_screens({Key? key}) :super(key: key);
        ...
        children : [
            ...
            Row(
              children: [
                ...
                const Text("YOGA \n> Mandukasana, Vakrasana, Ardha matyasana", style: TextStyle(color: Colors.purple, fontSize: 20)),
              ],
            ),
            Row(
              children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 20),
                const Text("> Dr.Sneha ,MD Lohita Hospital\n -- 747474747\n\n >Dr.Sameeksha ,MD AIIMES, Delhi\n -- 66464646", style: TextStyle(color: Colors.purple, fontSize: 20)),
              ],
            ), 
