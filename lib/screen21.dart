...
class Doc_screen extends StatelessWidget{
  const Doc_screen({Key? key}) :super(key: key);
        ...
        children : [
            ...
            Row(
              children: [
                ...
                const Text("YOGA \n>Dhanusana, Shavasana, Mandukasana", style: TextStyle(color: Colors.purple, fontSize: 20)),
              ],
            ),
            Row(
              children: [
